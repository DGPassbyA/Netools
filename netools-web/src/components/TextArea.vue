...
export default defineComponent({
  ...
  methods: {
      createText: function() {
        ...
        if(txt == null || txt == undefined || txt == 0) {
            return;
        }
...
<div class="h-full w-full flex flex-col items-center">
    <div class="h-5 pb-10 pt-7 w-1/2 md:w-4/5 sm:w-4/5 min:w-5/6">
    ...
    <div class="text-gray-70 h-3/4 w-1/2 md:w-4/5 sm:w-4/5 min:w-5/6 m-1">
